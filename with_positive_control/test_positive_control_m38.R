...
#### PATHS ####
raw_counts.path <- "female_cpid_multiregion/with_positive_control/m38/data/cpid_multireg_control_counts.txt"
coldata.path <- "female_cpid_multiregion/with_positive_control/m38/data/coldata_control.ods"
output.path <- "female_cpid_multiregion/with_positive_control/m38/data/2__differential_expression_analysis/CPID_sham_vs_cuff_betaprior.csv" # file to save results
...
# counts.path <- "female_cpid_multiregion/with_positive_control/m38/data/cpid_multireg_control_counts.txt"
...
output.path <- "female_cpid_multiregion/with_positive_control/m38/data/2__differential_expression_analysis/annotated_counts.csv"
...
test <-"female_cpid_multiregion/with_positive_control/m38/data/2__differential_expression_analysis/annotated_counts.csv"
...
ggplot(df_compare_plot, aes(x = diff_bin)) +
  geom_bar(fill = "steelblue", color = "black") +
  labs(
    title = "Histogramme des différences entre les résultats d'origines et le control positif, Ins 1787",
    x = "diff (counts test - counts origine)",
    y = "Nombre de gènes"
  ) +
  theme_minimal() +
