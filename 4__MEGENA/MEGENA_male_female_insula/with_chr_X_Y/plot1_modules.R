...
#### PATHS ####
MEGENA.Results.path <- paste0("data/4__MEGENA/MEGENA_male_female_insula/with_chr_X_Y/MEGENA.Results_", reg, ".Rdata")
print(MEGENA.Results.path)
output.path <- "graphs_results/4__MEGENA/MEGENA_male_female_insula/with_chr_X_Y/" # file to save results
