...
# PATHS
ijw.path <- paste0("data/4__MEGENA/MEGENA_male_female_insula/with_chr_X_Y/ijw_", reg, ".Rdata")
output.path <- paste0("data/4__MEGENA/MEGENA_male_female_insula/with_chr_X_Y/pfn_", reg, ".Rdata") # file to save results
