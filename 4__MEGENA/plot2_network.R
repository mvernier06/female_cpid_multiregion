...
alluvial_enrichment.path <- paste0("data/4__MEGENA/enrichment_alluvial/enrichment_alluvial_", reg, ".Rdata")
cell_types_enrichment <- paste0("data/4__MEGENA/enrichment_cell_types/enrichment_cell_types_", reg, ".Rdata")
plots.path <- paste0("graphs_results/4__MEGENA/", reg)
celltypes_plots.path <- paste0(plots.path, "/cell_types_network_plots_", reg)
output.path <- paste0("data/4__MEGENA/enrichment_cell_types/")
