...
#### PATHS ####
MEGENA.Results.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/MEGENA.Results_", reg, ".Rdata")
print(MEGENA.Results.path)
output.path <- paste0("graphs_results/4__MEGENA/MEGENA_without_RIN_correction/", reg) # file to save results
