...
# PATHS
pfn.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/pfn_", reg, ".Rdata")
output.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/MEGENA.Results_", reg, ".Rdata") # file to save results
