...
## INPUT ## 
Nac_modulePreservation_refMale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Nac/Nac_modulePreservation_refMale.Rdata"
Nac_modulePreservation_refFemale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Nac/Nac_modulePreservation_refFemale.Rdata"
Hb_modulePreservation_refMale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Hb/Hb_modulePreservation_refMale.Rdata"
Hb_modulePreservation_refFemale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Hb/Hb_modulePreservation_refFemale.Rdata"
Ins_modulePreservation_refMale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Ins/Ins_modulePreservation_refMale.Rdata"
Ins_modulePreservation_refFemale.path <- "data/4__MEGENA/MEGENA_without_RIN_correction/preservation_vs_male/Ins/Ins_modulePreservation_refFemale.Rdata"
