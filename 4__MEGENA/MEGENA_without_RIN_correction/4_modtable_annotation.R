...
#### PATHS ####
megena_results.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/MEGENA.Results_", reg, ".Rdata")
output.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/modtable_", reg, ".Rdata")
