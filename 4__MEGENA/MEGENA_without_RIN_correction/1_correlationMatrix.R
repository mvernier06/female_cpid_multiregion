...
# PATHS ####
CTF_normalized.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/CTF_normalized_counts_", reg, ".Rdata") # CTF normalized counts for the queried region
output.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/ijw_", reg, ".Rdata") # file to save results
