...
# PATHS
ijw.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/ijw_", reg, ".Rdata")
output.path <- paste0("data/4__MEGENA/MEGENA_without_RIN_correction/pfn_", reg, ".Rdata") # file to save results
