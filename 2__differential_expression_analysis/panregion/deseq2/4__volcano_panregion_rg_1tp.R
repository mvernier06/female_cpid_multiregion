...
for (tp in c("tp1", "tp2", "tp3")) {
  ...
  deg_tp <- paste0("data/2__differential_expression_analysis/panregion/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_", tp,".rds")
  volcano.path <- paste0("graphs_results/panregion/deseq2_reg_group/volcano_panregion/volcano_panregion_deg_", tp,".png")
