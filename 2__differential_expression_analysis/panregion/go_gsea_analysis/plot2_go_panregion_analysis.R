...
go_1 <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/go_panregion_1_obj.Rdata"

## OUTPUT ##
data <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/"
plot.file <- "graphs_results/panregion/go_gsea_analysis/go/"
