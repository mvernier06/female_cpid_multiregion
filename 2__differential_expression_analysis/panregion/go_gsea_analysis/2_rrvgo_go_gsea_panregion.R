...
## INPUT ## 
gsea_results <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/fgsea_panregion_01_obj.Rdata"
go_results <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/go_panregion_05_obj.Rdata"

## OUTPUT ##
# GSEA # 
reduced_gsea <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/gsea/reduced_terms/"
treemap_gsea <- "graphs_results/panregion/go_gsea_analysis/gsea/treemap"

# GO # 
reduced_go <- "data/2__differential_expression_analysis/panregion/go_gsea_analysis/go/reduced_terms/"
treemap_go <- "graphs_results/panregion/go_gsea_analysis/go/treemap"
