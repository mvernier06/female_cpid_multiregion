...
setwd(project.path)
## INPUT ## 
annotated_counts.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_alltp.rds"
deg_tp1 <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp1.rds"
deg_tp2 <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp2.rds"
deg_tp3 <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp3.rds"
...
## OUTPUT ##
output.path <- "data/2__differential_expression_analysis/panregion_common_regions/go_gsea_analysis/"
