...
### Excluding outliers and keeping only common regions ###
...
for (tp in c("1", "2", "3")){
  ...
  betaprior.path <- paste0("data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_betaprior_rg_tp",tp,".rds")                
  deseq2_results.path <- paste0("data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_deseq2_rg_tp",tp,".rds")       
  normalized_counts.path <- paste0("data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_normalized_counts_rg_tp",tp,".rds") 
