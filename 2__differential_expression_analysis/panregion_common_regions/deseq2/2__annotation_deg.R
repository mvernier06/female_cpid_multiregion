...
## INPUT ##
panregion_tp1.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_deseq2_rg_tp1.rds" # file with just deseq2 results 
panregion_tp2.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_deseq2_rg_tp2.rds"
panregion_tp3.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/deseq2_panregion/panregion_deseq2_rg_tp3.rds"

## OUTPUT ##
annotated_genes_tp1.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_tp1.rds"
annotated_genes_tp2.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_tp2.rds"
annotated_genes_tp3.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_tp3.rds"

annotated_genes_alltp.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_annotated_genes_alltp.rds"

deg_tp1.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp1.rds"
deg_tp2.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp2.rds"
deg_tp3.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_tp3.rds"

deg_alltp.path <- "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_alltp.rds"
