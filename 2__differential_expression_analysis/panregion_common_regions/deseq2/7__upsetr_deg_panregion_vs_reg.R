...
for (tp in timepoints) {
  ...
  panregion_deg.path <- paste0(
    "data/2__differential_expression_analysis/panregion_common_regions/deseq2/design_reg_group/annotation_deg/panregion_deg_", tp, ".rds"
  )
  
  #### OUTPUT ####
  upset.path <- paste0(
    "graphs_results/panregion_common_regions/deseq2_reg_group/upset_plots/upset_deg_panregion_vs_individual_reg_", tp, ".png"
  )
